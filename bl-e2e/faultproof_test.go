...
import (
	...
	"github.com/BLASTchain/blast/bl-e2e/e2eutils/disputegame"
	l2oo2 "github.com/BLASTchain/blast/bl-e2e/e2eutils/l2oo"
...
func TestCannonProposedOutputRootInvalid(t *testing.T) {
	...
	tests := []struct {
		...
		// performMove is called to respond to each claim posted by the honest bl-challenger.
