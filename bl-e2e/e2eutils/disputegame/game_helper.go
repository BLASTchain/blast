...
// It is assumed that the output root being disputed is valid and that an honest bl-challenger is already running.
...
// It is assumed that the output root being disputed is invalid and that an honest bl-challenger is already running.
