...
import (
	...
	"github.com/BLASTchain/blast/bl-node/rollup/sync"
...
// TestDropSpanBatchBeforeHardfork tests behavior of bl-node before SpanBatch hardfork.
// bl-node must drop SpanBatch before SpanBatch hardfork.
...
// TestAcceptSingularBatchAfterHardfork tests behavior of bl-node after SpanBatch hardfork.
// bl-node must accept SingularBatch after SpanBatch hardfork.
