...
The current version of `bl-node` uses the `v2` RPC methods from the engine API, whereas prior versions used the `v1`
...
withdrawals field is required to be non-nil. The bl-node should set the withdrawals field to be an empty list.
