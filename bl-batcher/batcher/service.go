...
import (
	...
	"github.com/BLASTchain/blast/bl-batcher/rpc"
...
// and conforms to the bl-service CLI Lifecycle interface.
...
func (bs *BatcherService) Stop(ctx context.Context) error {
	...
	if bs.rpcServer != nil {
		// TODO(7685): the bl-service RPC server is not built on top of bl-service httputil Server, and has poor shutdown
