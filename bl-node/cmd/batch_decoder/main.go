...
import (
	...
	"github.com/BLASTchain/blast/bl-node/cmd/batch_decoder/fetch"
	"github.com/BLASTchain/blast/bl-node/cmd/batch_decoder/reassemble"
	...
	app.Commands = []*cli.Command{
		...
		},
		{
			...
			Flags: []cli.Flag{
				&cli.StringFlag{
					Name:  "inbox",
					Value: "0xa7431bBE29cC82eA46e707280a4932FA881e9F41",
					Usage: "Batch Inbox Address",
				},
				&cli.StringFlag{
					Name:  "in",
