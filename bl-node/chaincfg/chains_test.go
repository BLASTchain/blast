...
// the configs that were embedded in the bl-node manually before the superchain-registry was utilized.
//
...
//
// This test ensures no bl-node config-loading behavior changes before
