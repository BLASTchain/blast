...
func TestGethAddresses(t *testing.T) {
	// We test if the addresses in geth match those in bl-bindings, to avoid an import-cycle:
	// we import geth in the monorepo, and do not want to import bl-bindings into geth.
