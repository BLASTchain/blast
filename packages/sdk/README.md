...
[![codecov](https://codecov.io/gh/BLASTchain/blast/branch/master/graph/badge.svg?token=0VTG7PG7YR&flag=sdk-tests)](https://codecov.io/gh/BLASTchain/blast)

The `@eth-blast/sdk` package provides a set of tools for interacting with Optimism.

## Installation

```
npm install @eth-blast/sdk
```
...
The [`CrossChainMessenger`](https://github.com/BLASTchain/blast/blob/develop/packages/sdk/src/cross-chain-messenger.ts) class simplifies the process of moving assets and data between Ethereum and Optimism.
...
The Optimism SDK includes [various utilities](https://github.com/BLASTchain/blast/blob/develop/packages/sdk/src/l2-provider.ts) for handling Optimism's [transaction fee model](https://community.optimism.io/docs/developers/build/transaction-fees/).
