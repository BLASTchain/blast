import { predeploys } from '@eth-blast/core-utils'
import { ethers } from 'ethers'
// import portalArtifactsMainnet from '@eth-blast/contracts-bedrock/deployments/mainnet/OptimismPortalProxy.json'
// import portalArtifactsGoerli from '@eth-blast/contracts-bedrock/deployments/goerli/OptimismPortalProxy.json'
// import portalArtifactsSepolia from '@eth-blast/contracts-bedrock/deployments/sepolia/OptimismPortalProxy.json'
// import l2OutputOracleArtifactsMainnet from '@eth-blast/contracts-bedrock/deployments/mainnet/L2OutputOracleProxy.json'
// import l2OutputOracleArtifactsGoerli from '@eth-blast/contracts-bedrock/deployments/goerli/L2OutputOracleProxy.json'
// import l2OutputOracleArtifactsSepolia from '@eth-blast/contracts-bedrock/deployments/sepolia/L2OutputOracleProxy.json'
// import addressManagerArtifactMainnet from '@eth-blast/contracts-bedrock/deployments/mainnet/AddressManager.json'
// import addressManagerArtifactGoerli from '@eth-blast/contracts-bedrock/deployments/goerli/AddressManager.json'
// import addressManagerArtifactSepolia from '@eth-blast/contracts-bedrock/deployments/sepolia/AddressManager.json'
// import l1StandardBridgeArtifactMainnet from '@eth-blast/contracts-bedrock/deployments/mainnet/L1StandardBridgeProxy.json'
// import l1StandardBridgeArtifactGoerli from '@eth-blast/contracts-bedrock/deployments/goerli/L1StandardBridgeProxy.json'
// import l1StandardBridgeArtifactSepolia from '@eth-blast/contracts-bedrock/deployments/sepolia/L1StandardBridgeProxy.json'
// import l1CrossDomainMessengerArtifactMainnet from '@eth-blast/contracts-bedrock/deployments/mainnet/L1CrossDomainMessengerProxy.json'
// import l1CrossDomainMessengerArtifactGoerli from '@eth-blast/contracts-bedrock/deployments/goerli/L1CrossDomainMessengerProxy.json'
// import l1CrossDomainMessengerArtifactSepolia from '@eth-blast/contracts-bedrock/deployments/sepolia/L1CrossDomainMessengerProxy.json'
import portalArtifactsBlast from '@eth-blast/contracts-bedrock/deployments/blast-mainnet/OptimismPortalProxy.json'
import l2OutputOracleArtifactsBlast from '@eth-blast/contracts-bedrock/deployments/blast-mainnet/L2OutputOracleProxy.json'
import addressManagerArtifactBlast from '@eth-blast/contracts-bedrock/deployments/blast-mainnet/AddressManager.json'
import l1StandardBridgeArtifactBlast from '@eth-blast/contracts-bedrock/deployments/blast-mainnet/L1StandardBridgeProxy.json'
import l1CrossDomainMessengerArtifactBlast from '@eth-blast/contracts-bedrock/deployments/blast-mainnet/L1CrossDomainMessengerProxy.json'
import portalArtifactsBlastGoerli from '@eth-blast/contracts-bedrock/deployments/blast-goerli/OptimismPortalProxy.json'
import l2OutputOracleArtifactsBlastGoerli from '@eth-blast/contracts-bedrock/deployments/blast-goerli/L2OutputOracleProxy.json'
import addressManagerArtifactBlastGoerli from '@eth-blast/contracts-bedrock/deployments/blast-goerli/AddressManager.json'
import l1StandardBridgeArtifactBlastGoerli from '@eth-blast/contracts-bedrock/deployments/blast-goerli/L1StandardBridgeProxy.json'
import l1CrossDomainMessengerArtifactBlastGoerli from '@eth-blast/contracts-bedrock/deployments/blast-goerli/L1CrossDomainMessengerProxy.json'
...
const portalAddresses = {
  ...
  blast: portalArtifactsBlast.address,
}
...
const l2OutputOracleAddresses = {
  ...
  blast: l2OutputOracleArtifactsBlast.address,
}
...
const addressManagerAddresses = {
  ...
  blast: addressManagerArtifactBlast.address,
}
...
const l1StandardBridgeAddresses = {
  ...
  blast: l1StandardBridgeArtifactBlast.address,
}
...
const l1CrossDomainMessengerAddresses = {
  ...
  blast: l1CrossDomainMessengerArtifactBlast.address,
}
...
const stateCommitmentChainAddresses = {
  ...
  blast: ethers.constants.AddressZero,
...
export const CONTRACT_ADDRESSES: {
  ...
  // },
  [L2ChainID.BLAST]: {
    l1: getL1ContractsByNetworkName('blast'),
    l2: DEFAULT_L2_CONTRACT_ADDRESSES,
  },
