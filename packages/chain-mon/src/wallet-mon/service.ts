import {
  ...
  validators,
  waitForProvider,
} from '@eth-blast/common-ts'
import { getChainId, compareAddrs } from '@eth-blast/core-utils'
import { Provider, TransactionResponse } from '@ethersproject/abstract-provider'
import mainnetConfig from '@eth-blast/contracts-bedrock/deploy-config/blast-mainnet.json'
import goerliConfig from '@eth-blast/contracts-bedrock/deploy-config/blast-goerli.json'
import l2OutputOracleArtifactsMainnet from '@eth-blast/contracts-bedrock/deployments/blast-mainnet/L2OutputOracleProxy.json'
import l2OutputOracleArtifactsGoerli from '@eth-blast/contracts-bedrock/deployments/blast-goerli/L2OutputOracleProxy.json'
