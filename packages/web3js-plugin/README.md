...
```bash
pnpm install @eth-blast/web3.js-plugin
```

```bash
npm install @eth-blast/web3.js-plugin
```

```bash
yarn add @eth-blast/web3.js-plugin
```
...
import { OptimismPlugin } from '@eth-blast/web3.js-plugin'
...
import { optimistABI, optimistAddress } from '@eth-blast/contracts-ts'
