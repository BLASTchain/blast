...
contract Deploy is Deployer {
    ...
    function implSalt() internal returns (bytes32) {
        return keccak256(bytes(vm.envOr("IMPL_SALT", string("ethers phoenix blast"))));
    }
    ...
    function setCannonFaultGameImplementation() public onlyDevnet broadcast {
        ...
        if (block.chainid == Chains.LocalDevnet || block.chainid == Chains.GethDevnet) {
            ...
            string memory filePath = string.concat(vm.projectRoot(), "/../../bl-program/bin/prestate-proof.json");
